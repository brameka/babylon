...
export class DataService {
    ...
    private data1: any = [
        ...
        },
        {
            ...
            tips: "Talk about each number and what they look like, which helps with number recognition.",
            description: `
                <h3>Description:</h3>
                <p>
                    Draw different numbers on the whiteboard and have your kid trace each number with pom poms.
                </p>
                <h3>Materials:</h3>
                <ul>
                    <li>Pom Poms</li>
